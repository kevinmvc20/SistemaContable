            ...
            <form action="{{route('register')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="ci" name="ci" type="text" 
                        placeholder="Tu cedula de identidad" class="border p-3 w-full rounded-lg @error('ci') border-red-500  @enderror"
                        value="{{old('ci')}}"
                    >
                ...
                <div class="mb-5">
                    ...
                    <input id="name" name="name" type="text" 
                        placeholder="Tu nombre" class="border p-3 w-full rounded-lg @error('name') border-red-500  @enderror"
                        value="{{old('name')}}"
                    >
